...
import main.User.LossAdjuster;
import main.User.ProductManagement;
import main.User.Sales;
import main.User.UnderWriter;
...
public class ResultSetWrapper {
  ...
  public User toUser(){
    ...
    switch (userTypeID){
        case 1:return new Customer(userID, userTypeID);
        case 2:return new Sales(userID, userTypeID);
        case 3:return new UnderWriter(userID, userTypeID);
        case 4:return new ProductManagement(userID, userTypeID);
        case 5:return new LossAdjuster(userID, userTypeID);
        default:
    }
    User user = new User(userID,userTypeID);
    return user;
  }
